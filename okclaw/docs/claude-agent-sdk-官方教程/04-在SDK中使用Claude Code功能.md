...
category: 核心概念
order: 4
source: https://code.claude.com/docs/zh-CN/agent-sdk/claude-code-features
---

> 📖 **本文是 [Claude Agent SDK 官方教程](https://code.claude.com/docs/zh-CN/agent-sdk/overview) 的中文文档翻译/整理。**
> 原文链接：<https://code.claude.com/docs/zh-CN/agent-sdk/claude-code-features>
>
> 分类：**核心概念** ｜ 教程目录：[README](./README.md)
