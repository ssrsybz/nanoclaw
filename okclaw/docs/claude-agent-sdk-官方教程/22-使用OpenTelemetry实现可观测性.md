---
title: 使用 OpenTelemetry 实现可观测性
category: 控制和可观测性
order: 22
source: https://code.claude.com/docs/zh-CN/agent-sdk/observability
---

> 📖 **本文是 [Claude Agent SDK 官方教程](https://code.claude.com/docs/zh-CN/agent-sdk/overview) 的中文文档翻译/整理。**
> 原文链接：<https://code.claude.com/docs/zh-CN/agent-sdk/observability>
>
> 分类：**控制和可观测性** ｜ 教程目录：[README](./README.md)
